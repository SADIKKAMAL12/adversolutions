-- ═══════════════════════════════════════════════════════════════
-- AdverSolutions - Clean Idempotent Setup Script
-- Run this ONCE in Supabase SQL Editor
-- Safe to re-run: uses IF NOT EXISTS + ON CONFLICT DO NOTHING
-- ═══════════════════════════════════════════════════════════════

-- ============================================================
-- TABLES (IF NOT EXISTS - never drops existing data)
-- ============================================================
...
-- Rich payment_methods schema (matches frontend with bank_name, logo, fields)
...
-- Rich payment_methods with bank_name, logo, fields (matches frontend)
...
-- Helper: create policies idempotently
...
UNION ALL SELECT 'inventory_lines', count(*) FROM inventory_lines
UNION ALL SELECT 'media_buyers', count(*) FROM media_buyers
