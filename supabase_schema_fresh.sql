-- ============================================================
-- AdverSolutions - Fresh Supabase Schema
-- Run this in Supabase SQL Editor (New Query)
-- This drops all existing data and recreates everything fresh
-- ============================================================
...
-- Seed users
-- Password for all demo users: "password" (bcrypt hash below)
-- Password for admin: "admin2024" (bcrypt hash below)
...
-- Update rejected buyer with reason
...
-- Allow all operations (application handles auth)
