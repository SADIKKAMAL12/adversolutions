...
import { Logo, Input, Btn } from "../shared/UI";
...
═══════════════════════════════════════════════════ */
export default function UserLoginPage({ onLogin, goToAdmin }) {
      ...
      <div style={{ width:480, display:"flex", alignItems:"center", justifyContent:"center", padding:"40px 50px" }}>
        <div style={{ width:"100%", background:"#fff", borderRadius:24, padding:"40px 36px", boxShadow:"0 40px 80px rgba(0,0,0,.4)" }}>
          ...
          <div style={{ textAlign:"center", marginTop:14 }}>
            <span style={{ fontSize:12, color:C.g400 }}>Are you an admin?{" "}</span>
            <span onClick={goToAdmin} style={{ fontSize:12, color:C.primary, cursor:"pointer", fontWeight:700 }}>Admin Login →</span>
          </div>
        </div>
      </div>
    </div>
